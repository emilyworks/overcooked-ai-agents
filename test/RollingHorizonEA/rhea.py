...
class RollingHorizonEvolutionaryAlgorithm():
    ...
    def _get_next_action(self):
        ...
        candidate_solutions = self._mutate(
            solution, self._mutation_probability)
        ...
        self._logger.info('Best score in evaluations: %.2f' %
                          best_score_in_evaluations)
        # ADD CODE HERE FOR OVERCOOKED
    ...
    def _shift_and_append(self, solution):
        ...
        new_solution = np.vstack(
            [new_solution, self._environment.get_random_action()])
        return new_solution
    ...
    def _mutate(self, solution, mutation_probability):
        ...
        for b in range(self._num_evals):
            ...
            mutations = [self._environment.get_random_action()
